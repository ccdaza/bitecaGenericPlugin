...
class inc extends Form {
    ...
    function __construct($plugin, $journalId) {
        ...
        $this->addCheck(new FormValidator($this, 'token', 'required', 'plugins.generic.carruselPastIssuesBitecaForm.manager.token.required'));
        $this->addCheck(new FormValidator($this, 'client_id', 'required', 'plugins.generic.carruselPastIssuesBitecaForm.manager.clientId.required'));
    ...
    function getIssues(){
        ...
        foreach($this->_plugin->getIssues() as $issue){
            $issues[$issue->getId()] = $issue->getLocalizedTitle() ." (". $issue->getIssueSeries() .")";
        }
